@extends('layouts.vertical', ['title' => 'Range sliders'])
...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Extended UI', 'title' => 'Range sliders'])
<div class="row">
    <div class="col-12">
        <div class="card">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label for="range_02" class="col-lg-2 control-label">Min-Max<span
                                class=" font-12 d-block text-muted clearfix">Set min value, max value and start
                                point</span></label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group row">
                        <label for="range_03" class="col-lg-2 control-label">Prefix<span
                                class="font-12 d-block text-muted clearfix">showing grid and adding prefix
                                "$"</span></label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group row">
                        <label for="range_04" class="col-lg-2 control-label">Range<span
                                class="d-block font-12 text-muted clearfix">Set up range with negative
                                values</span></label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group row">
                        <label for="range_07" class="col-lg-2 control-label">Prettify Numbers<span
                                class="d-block font-12 text-muted clearfix">Prettify enabled. Much
                                better!</span></label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group row">
                        <label for="range_08" class="col-lg-2 control-label">Disabled<span
                                class="d-block font-12 text-muted clearfix">Lock slider by using disable
                                option</span></label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group row">
                        <label for="range_09" class="col-lg-2 control-label">Extra Example<span
                                class="d-block font-12 text-muted clearfix">Whant to show that max number is not the
                                biggest one?</span></label>
                        <div class="col-lg-10">
...
@section('scripts')
@vite(['resources/js/pages/range-sliders.js'])
@endsection