@extends('layouts.vertical',['title' => 'Nestable Lists'])
...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Extended UI', 'title' => 'Nestable Lists'])
<div class="row">
    <div class="col-lg-12">
        <div class="text-left" id="nestable_list_menu">
            <button type="button" class="btn btn-pink waves-effect waves-light me-1" data-action="expand-all">Expand All</button>
...
@section('scripts')
@vite(['resources/js/pages/nestable.js'])
@endsection