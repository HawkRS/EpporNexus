@extends('layouts.vertical',['title' => 'Tiles'])
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="avatar-lg bg-icon rounded-circle align-self-center">
                        <img class="avatar-sm" src="/images/icons/clock.svg" title="clock.svg">
                    </div>
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card widget-box-three">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="avatar-lg bg-icon rounded-circle align-self-center">
                        <img class="avatar-sm" src="/images/icons/advertising.svg" title="advertising.svg">
                    </div>
                    <div class="wigdet-two-content media-body text-end text-truncate  text-right">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card widget-box-three">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="avatar-lg bg-icon rounded-circle align-self-center">
                        <img class="avatar-sm" src="/images/icons/paid.svg" title="paid.svg">
                    </div>
                    <div class="wigdet-two-content media-body text-end text-truncate  text-right">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card widget-box-three">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="avatar-lg bg-icon rounded-circle align-self-center">
                        <img class="avatar-sm" src="/images/icons/timeline.svg" title="timeline.svg">
                    </div>
                    <div class="wigdet-two-content media-body text-end text-truncate  text-right">
...
<div class="row">
    <div class="col-xl-3 col-sm-6">
        <div class="card widget-user">
            <div class="card-body">
                <img src="/images/users/avatar-3.jpg" class="img-fluid rounded-circle avatar-md" alt="user">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card widget-user">
            <div class="card-body">
                <img src="/images/users/avatar-2.jpg" class="img-fluid rounded-circle avatar-md" alt="user">
                <div class="wid-u-info">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card widget-user">
            <div class="card-body">
                <img src="/images/users/avatar-1.jpg" class="img-fluid rounded-circle avatar-md" alt="user">
                <div class="wid-u-info">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card widget-user">
            <div class="card-body">
                <img src="/images/users/avatar-10.jpg" class="img-fluid rounded-circle avatar-md" alt="user">
                <div class="wid-u-info">
