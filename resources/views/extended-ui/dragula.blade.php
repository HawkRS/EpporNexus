...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Extended UI', 'title' => 'Dragula'])
<div class="row">
    <div class="col-12">
        <div class="card">
                                            ...
                                            <div class="w-100 overflow-hidden">
                                                ...
                                                <p class="mb-0 card-subtitle">
                                                    <span class="fst-italic"><b>"</b>Disrupt pork belly poutine,
                                                        asymmetrical tousled succulents selfies. You probably haven't
                                                        heard of them tattooed master cleanse live-edge keffiyeh.</span>
                                                </p>
                                            </div> <!-- end w-100 -->
                                        </div> <!-- end d-flex -->
                                    </div> <!-- end card-body -->
...
@section('scripts')
@vite(['resources/js/pages/extended-dragula.js'])
@endsection