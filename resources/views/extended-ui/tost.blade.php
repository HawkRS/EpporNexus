...
@section('css')
@vite(['node_modules/toastr/build/toastr.min.css'])
@endsection

@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Extended UI', 'title' => 'Toasts'])
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-2">
                    <div class="col-12">
                        <div>
                            <button type="button" class="btn btn-primary waves-effect waves-light me-1 mt-2" id="showtoast">Show Toast</button>
                            <button type="button" class="btn btn-danger waves-effect waves-light me-1 mt-2" id="cleartoasts">Clear Toasts</button>
                            <button type="button" class="btn btn-danger waves-effect waves-light me-1 mt-2" id="clearlasttoast">Clear Last Toast</button>
                        </div>
                    </div>
                </div>
...
@section('scripts')
@vite(['resources/js/pages/toastr.js'])
@endsection