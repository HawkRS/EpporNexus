...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'pages', 'title' => 'Invoice'])
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mt-3 text-md-end">
                            ...
                            <p><strong>Order Status: </strong> <span class="badge bg-success">Paid</span></p>
                ...
                <div class="hidden-print mt-4">
                    <div class="text-end d-print-none">
                        <a href="javascript:window.print()" class="btn btn-primary waves-effect waves-light"><i
                                class="fa fa-print me-1"></i> Print</a>
