@extends('layouts.vertical', ['title' => 'Contact Us'])

@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'pages', 'title' => 'Contact Us'])
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-md-10">
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                ...
                                <p class="text-muted sub-title">The clean and well commented code allows easy
