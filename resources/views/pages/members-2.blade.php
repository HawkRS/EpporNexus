@extends('layouts.vertical', ['title' => 'Members 2'])
...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'pages', 'title' => 'Members 2'])
<div class="row">
    <div class="col-sm-4">
        <a href="#custom-modal" class="btn btn-primary waves-effect waves-light mb-3" data-animation="fadein"
            data-bs-plugin="custommodal" data-overlaySpeed="200" data-overlayColor="#36404a"><i class="md md-add"></i> Add
            Member</a>
    </div><!-- end col -->
    <div class="col-sm-8">
            ...
            <div class="card-body">
                <div class="member-card-alt">
                    <div class="avatar-xxl member-thumb mb-2 float-start">
                        <img src="/images/users/avatar-3.jpg" class="img-thumbnail" alt="profile-image">
                    ...
                    <div class="member-card-alt-info">
                        ...
                        <button type="button" class="btn btn-primary btn-sm mt-2 waves-effect waves-light"> Edit
                        </button>
                        <button type="button" class="btn btn-link text-danger btn-sm mt-2 waves-effect waves-light">
                            Delete </button>
                    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <div class="member-card-alt">
                    <div class="avatar-xxl member-thumb mb-2 float-start">
                        <img src="/images/users/avatar-5.jpg" class="img-thumbnail" alt="profile-image">
                        <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <div class="member-card-alt">
                    <div class="avatar-xxl member-thumb mb-2 float-start">
                        <img src="/images/users/avatar-2.jpg" class="img-thumbnail" alt="profile-image">
                        <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <div class="member-card-alt">
                    <div class="avatar-xxl member-thumb mb-2 float-start">
                        <img src="/images/users/avatar-4.jpg" class="img-thumbnail" alt="profile-image">
                        <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <div class="member-card-alt">
                    <div class="avatar-xxl member-thumb mb-2 float-start">
                        <img src="/images/users/avatar-6.jpg" class="img-thumbnail" alt="profile-image">
                        <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <div class="member-card-alt">
                    <div class="avatar-xxl member-thumb mb-2 float-start">
                        <img src="/images/users/avatar-7.jpg" class="img-thumbnail" alt="profile-image">
                        <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <div class="member-card-alt">
                    <div class="avatar-xxl member-thumb mb-2 float-start">
                        <img src="/images/users/avatar-8.jpg" class="img-thumbnail" alt="profile-image">
                        <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <div class="member-card-alt">
                    <div class="avatar-xxl member-thumb mb-2 float-start">
                        <img src="/images/users/avatar-9.jpg" class="img-thumbnail" alt="profile-image">
                        <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <div class="member-card-alt">
                    <div class="avatar-xxl member-thumb mb-2 float-start">
                        <img src="/images/users/avatar-10.jpg" class="img-thumbnail" alt="profile-image">
                        <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                    </div>
