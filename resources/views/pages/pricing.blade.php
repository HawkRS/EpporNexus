        ...
        <div class="row mt-4 pt-3">
            ...
            <article class="pricing-column col-md-4">
                <div class="inner-box card">
                    <div class="card-body">
                        ...
                        <div class="plan-header text-white text-center bg-primary p-3 rounded">
                            <h3 class="plan-title text-white text-uppercase my-2 font-16">Professional Pack</h3>
            ...
            <article class="pricing-column col-md-4">
                <div class="inner-box card">
                    <div class="card-body">
                        <div class="plan-header text-white text-center bg-primary p-3 rounded">
                            <h3 class="plan-title text-white text-uppercase my-2 font-16">Enterprise Pack</h3>
