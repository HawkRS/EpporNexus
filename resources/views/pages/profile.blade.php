...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'pages', 'title' => 'Profile'])
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="profile-user-box">
            <div class="row">
                <div class="col-sm-6">
                    <span class="float-start me-3"><img src="/images/users/avatar-1.jpg" alt=""
            ...
            <div class="card-body">
                ...
                <div class="panel-body">
                    <p class="text-muted font-13">
                        Hye, I’m Johnathan Doe residing in this beautiful world. I create websites and mobile apps with
                        great UX and UI design. I have done work with big companies like Nokia, Google and Yahoo. Meet
                        me or Contact me for any queries. One Extra line for filling space. Fill as many you want.
                    </p>

                    <hr />

                    <div class="text-left">
                        <p class="text-muted font-13"><strong>Full Name :</strong> <span class="ms-3">Johnathan
                                Deo</span></p>

                        <p class="text-muted font-13"><strong>Mobile :</strong><span class="ms-3">(+12) 123 1234
                                567</span></p>

                        <p class="text-muted font-13"><strong>Email :</strong> <span
                                class="ms-3">coderthemes@gmail.com</span></p>
            ...
            <div class="card-body">
                ...
                <div class="inbox-widget">
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="/images/users/avatar-2.jpg" class="rounded-circle"
                                alt=""></div>
                        <p class="inbox-item-author">Tomaslau</p>
                        <p class="inbox-item-text">I've finished it! See you so...</p>
                        <p class="inbox-item-date mt-2">
                            <button type="button" class="btn btn-sm waves-effect waves-light btn-success"> Reply
                            </button>
                        </p>
                    </div>
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="/images/users/avatar-3.jpg" class="rounded-circle"
                                alt=""></div>
                    ...
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="/images/users/avatar-4.jpg" class="rounded-circle"
                                alt=""></div>
                    ...
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="/images/users/avatar-5.jpg" class="rounded-circle"
                                alt=""></div>
                    ...
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="/images/users/avatar-6.jpg" class="rounded-circle"
                                alt=""></div>
                ...
                <div class="card widget-box-four">
                    <div class="card-body">
                        ...
                        <div class="float-start">
                            <h4 class="mt-0 font-16 mb-1 text-overflow fw-semibold" title="Total Revenue">Total
                                Revenue</h4>
                            <p class="fs-secondary text-muted">Jan - Apr 2017</p>
                            <h3 class="mb-0 mt-4 fw-semibold"><span>$</span> <span
            ...
            <div class="col-lg-4">
                <div class="card widget-box-four">
                    <div class="card-body">
                        ...
                        <div class="float-start">
                            <h4 class="mt-0 font-16 mb-1 text-overflow fw-semibold" title="Total Unique Visitors">
            ...
            <div class="col-lg-4">
                <div class="card widget-box-four">
                    <div class="card-body">
                        ...
                        <div class="float-start">
                            <h4 class="mt-0 font-16 mb-1 text-overflow fw-semibold" title="Number of Transactions">
