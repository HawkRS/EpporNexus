        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="home-wrapper text-center">
                    ...
                    <h2 class="text-white text-uppercase mt-4 fw-semibold">Stay tunned, we're launching very soon</h2>

                    <div class="row text-center justify-content-center mt-5 gx-2">
                        <div class="col-6 col-sm-4 col-md-3 col-lg-2 mb-3 mb-lg-0">
                            <div class="">
                                <h1 id="days" class="font-48 text-white fw-bold">00</h1>
                                <p class="text-uppercase text-white font-16 mb-0">Days</p>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4 col-md-3 col-lg-2 mb-3 mb-lg-0">
                            <div class="">
                                <h3 id="hours" class="font-48 text-white fw-bold">00</h3>
                                <p class="text-uppercase text-white font-16 mb-0">Hours</p>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4 col-md-3 col-lg-2 mb-3 mb-md-0">
                            <div class="">
                                <h3 id="minutes" class="font-48 text-white fw-bold">00</h3>
                                <p class="text-uppercase text-white font-16 mb-0">Minutes</p>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                            <div class="">
                                <h3 id="seconds" class="font-48 text-white fw-bold">00</h3>
                                <p class="text-uppercase text-white font-16 mb-0">Seconds</p>
                            </div>
                        </div>
                    </div>
