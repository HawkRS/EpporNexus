@extends('layouts.vertical', ['title' => 'Search Result'])

@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'pages', 'title' => 'Search Result'])
<div class="row">
    <div class="col-lg-12">
            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                            ...
                            <div class="col-md-12">
                                <div class="search-item">
                                    ...
                                    <div class="font-13 text-success mb-3">
                                        http://coderthemes.com/zircos/{{ route('root') }}
                                    </div>
                                ...
                                <div class="search-item">
                                    <h5 class="mb-1 fw-semibold"><a href="#">Adminox - Responsive Bootstrap 4 Web
                                            App Kit</a></h5>
                                    <div class="font-13 text-success mb-3">
                                ...
                                <div class="search-item">
                                    <div class="d-flex gap-3">
                                        <img class="d-flex me-3 rounded-circle" src="/images/users/avatar-1.jpg"
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="mb-0 font-13">
                                                <b>Bio:</b>
                                                <br />
                                                <span class="text-muted">Cras sit amet nibh libero, in gravida nulla.
                    ...
                    <div class="tab-pane" id="users">
                            ...
                            <div class="d-flex gap-3 mt-1">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="mb-0 font-13">
                                        <b>Bio:</b>
                                        <br />
                                        <span class="text-muted">Cras sit amet nibh libero, in gravida nulla. Nulla vel
                                            metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in
                        ...
                        <div class="search-item">
                            <div class="d-flex gap-3">
                                <img class="d-flex me-3 rounded-circle" src="/images/users/avatar-3.jpg"
                                    alt="Generic placeholder image" height="54">
                                <div class="media-body">
                                    <h5 class="media-heading mt-0">
                                        <a href="#" class="text-dark">Chadengle</a>
                        ...
                        <div class="search-item">
                            <div class="d-flex gap-3">
                                <img class="d-flex me-3 rounded-circle" src="/images/users/avatar-4.jpg"
                                    alt="Generic placeholder image" height="54">
                                <div class="media-body">
                                    <h5 class="media-heading mt-0">
                                        <a href="#" class="text-dark">Chadengle</a>
                        ...
                        <div class="search-item">
                            <div class="d-flex gap-3">
                                <img class="d-flex me-3 rounded-circle" src="/images/users/avatar-5.jpg"
                                    alt="Generic placeholder image" height="54">
                                <div class="media-body">
                                    <h5 class="media-heading mt-0">
                                        <a href="#" class="text-dark">Chadengle</a>
