...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Knob', 'title' => 'Jquery Knob Charts'])
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="p-3 text-center" dir="ltr">
                            <input data-plugin="knob" data-width="150" data-height="150" data-min="-100"
                                data-fgColor="#ff5d48" data-displayPrevious=true data-angleOffset=-125 data-angleArc=250
                                value="44" />
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="p-3 text-center" dir="ltr">
                            <input data-plugin="knob" data-width="150" data-height="150" data-angleOffset="90"
                                data-linecap="round" data-fgColor="#2b3d51" value="35" />
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="p-3 text-center" dir="ltr">
                            <input data-plugin="knob" data-width="150" data-height="150" data-min="-15000"
                                data-displayPrevious=true data-max="15000" data-step="1000" value="-11000"
                                data-fgColor="#9261c6" />
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="p-3 text-center" dir="ltr">
                            <input data-plugin="knob" data-width="150" data-height="150" data-displayPrevious=true
                                data-fgColor="#039cfd" data-skin="tron" data-cursor=true value="75"
