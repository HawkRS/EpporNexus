...
@section('css')
@vite(['node_modules/chartist/dist/chartist.min.css'])
@endsection


@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Chartist', 'title' => 'Chartist Charts'])
<div class="row">
    <div class="col-xl-6">
        <div class="card">
...
@vite(['resources/js/pages/chartist.js'])
@endsection