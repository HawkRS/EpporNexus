...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Email', 'title' => 'Inbox'])
<div class="row">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="inbox-leftbar">
                    ...
                    <a href="{{ route ('second' , ['apps','email-compose']) }}" class="btn btn-danger btn-block waves-effect w-100 waves-light">Compose</a>

                    <div class="mail-list mt-3">
                        <a href="#" class="list-group-item border-0 text-danger"><i class="mdi mdi-inbox font-18 align-middle me-2"></i>Inbox<span class="badge bg-danger float-end ms-2 mt-1">8</span></a>
                        <a href="#" class="list-group-item border-0"><i class="mdi mdi-star font-18 align-middle me-2"></i>Starred</a>
                        <a href="#" class="list-group-item border-0"><i class="mdi mdi-file-code font-18 align-middle me-2"></i>Draft<span class="badge bg-info float-end ms-2 mt-1">32</span></a>
                        <a href="#" class="list-group-item border-0"><i class="mdi mdi-send font-18 align-middle me-2"></i>Sent Mail</a>
                        <a href="#" class="list-group-item border-0"><i class="mdi mdi-delete font-18 align-middle me-2"></i>Trash</a>
                    </div>

                    <h5 class="mt-4">Labels</h5>

                    <div class="list-group b-0 mail-list mt-4">
                        <a href="#" class="list-group-item border-0"><span class="fa fa-circle text-info me-2"></span>Web App</a>
                        <a href="#" class="list-group-item border-0"><span class="fa fa-circle text-warning me-2"></span>Recharge</a>
                        <a href="#" class="list-group-item border-0"><span class="fa fa-circle text-purple me-2"></span>Wallet Balance</a>
                        <a href="#" class="list-group-item border-0"><span class="fa fa-circle text-pink me-2"></span>Friends</a>
                        <a href="#" class="list-group-item border-0"><span class="fa fa-circle text-success me-2"></span>Family</a>
                    </div>
                ...
                <div class="inbox-rightbar">
                    ...
                    <div class="" role="toolbar">
                        ...
                        <div class="btn-group me-1">
                            <button type="button" class="btn btn-sm btn-light dropdown-toggle waves-effect drop-arrow-none" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="btn-group me-1">
                            <button type="button" class="btn btn-sm btn-light dropdown-toggle waves-effect drop-arrow-none" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="mdi mdi-dots-horizontal font-18 align-middle me-1"></i> More <i class="mdi mdi-chevron-down"></i>
                            </button>
                            <div class="dropdown-menu">
