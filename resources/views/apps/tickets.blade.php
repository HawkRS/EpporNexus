@extends('layouts.vertical', ['title' => 'Tickets'])
...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Apps', 'title' => 'Tickets'])
<div class="row">
    <div class="col-12">
        <div class="card">
                ...
                <table class="table table-hover m-0 tickets-list table-actions-bar dt-responsive nowrap"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="javascript: void(0);" class="text-body">
                                    <img src="/images/users/avatar-10.jpg" alt="contact-img" title="contact-img"
                                        class="rounded-circle avatar-sm" />
                                </a>
                            </td>
                            ...
                            <td>
                                <div class="btn-group dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="#"><i
                                                class="mdi mdi-star me-2 font-18 text-muted vertical-middle"></i>Mark as
                                            Favorite</a>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript: void(0);" class="text-body">
                                    <img src="/images/users/avatar-9.jpg" alt="contact-img" title="contact-img"
                                        class="rounded-circle avatar-sm" />
                                </a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript: void(0);" class="text-body">
                                    <img src="/images/users/avatar-1.jpg" alt="contact-img" title="contact-img"
                                        class="rounded-circle avatar-sm" />
                                </a>
                            </td>
