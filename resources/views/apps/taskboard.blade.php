@extends('layouts.vertical', ['title' => 'Taskboard'])

@section('css')
@vite(['node_modules/@adactive/bootstrap-tagsinput/dist/bootstrap-tagsinput.css'])
@endsection

@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Apps', 'title' => 'Taskboard'])
<div class="row">
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                ...
                <ul class="sortable-list taskList list-unstyled" id="upcoming">
                    <li class="bg-soft-warning" id="task1">
                        <div class="checkbox checkbox-primary checkbox-single float-end">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="mb-0"><a href="" class="text-muted"><img
                                        src="/images/users/avatar-1.jpg" alt="task-user"
                                        class="avatar-sm rounded-circle me-2"> <span
                                        class="fw-medium font-secondary">Petey Cruiser</span></a> </p>
                        </div>
                    </li>
                    <li class="bg-soft-success" id="task2">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="mb-0"><a href="" class="text-muted"><img
                                        src="/images/users/avatar-2.jpg" alt="task-user"
                                        class="avatar-sm rounded-circle me-2"> <span
                                        class="fw-medium font-secondary">Anna Sthesia</span></a> </p>
                        </div>
                    </li>
                    <li id="task3">
                        <div class="checkbox checkbox-primary checkbox-single float-end">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="mb-0"><a href="" class="text-muted"><img
                                        src="/images/users/avatar-3.jpg" alt="task-user"
                                        class="avatar-sm rounded-circle me-2"> <span
                                        class="fw-medium font-secondary">Gail Forcewind</span></a> </p>
                        </div>
                    </li>
                    <li class="bg-soft-info" id="task4">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="mb-0"><a href="" class="text-muted"><img
                                        src="/images/users/avatar-4.jpg" alt="task-user"
                                        class="avatar-sm rounded-circle me-2"> <span
                                        class="fw-medium font-secondary">Maya Didas</span></a> </p>
                        </div>
                    </li>
                    <li class="bg-soft-danger" id="task5">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="mb-0"><a href="" class="text-muted"><img
                                        src="/images/users/avatar-5.jpg" alt="task-user"
                                        class="avatar-sm rounded-circle me-2"> <span
                                        class="fw-medium font-secondary">Rick O'Shea</span></a> </p>
                        </div>
                    </li>
                </ul>
                <a href="#" class="btn btn-secondary btn-block mt-3 waves-effect waves-light w-100">Add New</a>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
            ...
            <div class="modal-body">
                ...
                <div class="p-2 task-detail">
                    <div class="media mb-3">
                        <img class="d-flex me-3 rounded-circle" src="/images/users/avatar-2.jpg"
                    ...
                    <div class="assign-team mt-4">
                        ...
                        <div>
                            <a href="#"> <img class="rounded-circle avatar-sm" alt="64x64"
                                    src="/images/users/avatar-2.jpg"> </a>
                            <a href="#"> <img class="rounded-circle avatar-sm" alt="64x64"
                                    src="/images/users/avatar-3.jpg"> </a>
                            <a href="#"> <img class="rounded-circle avatar-sm" alt="64x64"
                                    src="/images/users/avatar-5.jpg"> </a>
                            <a href="#"> <img class="rounded-circle avatar-sm" alt="64x64"
                                    src="/images/users/avatar-8.jpg"> </a>
                        </div>
                    </div>
                    ...
                    <div class="attached-files mt-4">
                        ...
                        <div class="files-list">
                            ...
                            <div class="file-box">
                                <a href=""><img src="/images/attached-files/img-3.png"
                                        class="img-fluid img-thumbnail" alt="attached-img"></a>
...
@section('scripts')
@vite(['resources/js/pages/taskboard.js'])
@endsection