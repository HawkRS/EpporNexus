@extends('layouts.vertical', ['title' => 'Read Email'])

@section('css')
<!-- Summernote css -->
@vite(['node_modules/summernote/dist/summernote-bs4.min.css'])
@endsection


@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Email', 'title' => 'Read Email'])
<div class="row">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="inbox-leftbar">
                    ...
                    <a href="{{ route ('second' , ['apps','email-compose']) }}"
                ...
                <div class="inbox-rightbar">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="d-flex mb-4 mt-1">
                            <img class="d-flex me-3 rounded-circle avatar-sm" src="/images/users/avatar-2.jpg"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-md-4">
                                <a href="#"> <img src="/images/attached-files/img-3.png" alt="attachment"
                                        class="img-thumbnail img-fluid"> </a>
                            </div>
                        </div>
                    </div> <!-- card-box -->
                    ...
                    <div class="d-flex mb-0 mt-5">
                        <img class="d-flex me-3 rounded-circle avatar-sm" src="/images/users/avatar-7.jpg"
                            alt="Generic placeholder image">
                    ...
                    <div class="text-end">
                        <button type="button"
                            class="btn btn-primary rounded-pill waves-effect waves-light width-lg">Send</button>
                    </div>
...
@section('scripts')
@vite(['resources/js/pages/email-read.js'])
@endsection