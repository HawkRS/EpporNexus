...
@section('css')
@vite(['node_modules/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css'])
@endsection

@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Forms', 'title' => 'Dashboard'])
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h5 class="header-title mb-0">Flatpickr - Datepicker</h5>
            </div><!-- end card header -->
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h5 class="header-title mb-0">Flatpickr - Timepicker</h5>
            </div><!-- end card header -->
                ...
                <div>
                    <form action="#">
                        <div class="form-group">
                            <label>Default</label>
                            <input type="text" id="default-colorpicker" class="form-control" value="#1bb99a">
                        </div>
                        <div class="form-group">
                            <label>RGBA</label>
                            <input type="text" id="rgba-colorpicker" class="form-control" value="rgba(255, 122, 163,0.78)" data-color-format="rgba">
                        </div>
                        <div class="form-group">
                            <label>As Component</label>
                            <div id="component-colorpicker" class="input-group" title="Using format option">
                                <input type="text" class="form-control input-lg" value="#64b0f2" />
...
@section('scripts')
@vite(['resources/js/pages/form-flatpickr.js'])
@endsection