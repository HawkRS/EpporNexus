...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'Dashboard'])
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="header-title">Colored links</h5>
                <p class="card-subtitle">You can use the <code>.link-*</code> classes to colorize links. Unlike the <a
                        href="{{ route ('second' , ['base-ui','utilities']) }}"><code>.text-*</code> classes</a>, these classes have a
                    <code>:hover</code> and <code>:focus</code> state. Some of the link styles use a relatively light
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle"><a href="{{ route ('second' , ['base-ui','utilities']) }}">Colored link helpers</a> have been updated to pair
                    with our link utilities. Use the new utilities to modify the link opacity, underline opacity, and
                    underline offset.</p>
            </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Change the alpha opacity of the link <code>rgba()</code> color value with
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Change the underline’s color independent of the link text color.</p>
            </div>
            ...
            <div class="card-body pt-2">
                ...
                <p><a href="#" class="text-decoration-underline link-underline-warning">Warning underline</a>
                </p>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Just like the <code>.link-opacity-*-hover</code> utilities,
