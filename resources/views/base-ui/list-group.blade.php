...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'List Group'])
<div class="row">
    <div class="col-xl-4">
        <div class="card">
            ...
            <div class="card-body pt-2">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><i class="ti ti-brand-google-drive me-1 align-middle font-18"></i>
                        Google Drive</li>
                    <li class="list-group-item"><i class="ti ti-brand-messenger me-1 align-middle font-18"></i>
                        Facebook Messenger</li>
                    <li class="list-group-item"><i class="ti ti-brand-apple me-1 align-middle font-18"></i> Apple
                        Technology Company</li>
                    <li class="list-group-item"><i class="ti ti-brand-intercom me-1 align-middle font-18"></i> Intercom
                        Support System</li>
                    <li class="list-group-item"><i class="ti ti-brand-paypal me-1 align-middle font-18"></i> Paypal
                        Payment Gateway</li>
                </ul>
            ...
            <div class="card-body pt-2">
                <ul class="list-group">
                    <li class="list-group-item active"><i
                            class="ti ti-brand-google-drive me-1 align-middle font-18"></i> Google Drive</li>
                    <li class="list-group-item"><i class="ti ti-brand-messenger me-1 align-middle font-18"></i>
                        Facebook Messenger</li>
                    <li class="list-group-item"><i class="ti ti-brand-apple me-1 align-middle font-18"></i> Apple
                        Technology Company</li>
    ...
    <div class="col-xl-4">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Add <code>.disabled</code> to a <code>.list-group-item</code> to make it
