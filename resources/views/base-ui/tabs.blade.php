...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'Tabs'])
<div class="row">
    <div class="col-xl-6">
        <div class="card">
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Using class <code>.nav-justified</code>, you can force your <code>tab menu items</code> to use the full available width.</p>
            </div>
