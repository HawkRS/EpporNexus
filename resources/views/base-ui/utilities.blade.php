...
@include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'Utilities'])
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Similar to the contextual text color classes, set the background
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">By adding a <code>.bg-gradient</code> class, a linear gradient is
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-column gap-2">
                            ...
                            <div class="bg-light-subtle p-2"><code class="text-light-emphasis">.bg-light-subtle</code>
                            </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Color and background helpers combine the power of our
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle font-14">You can use the <code>.link-*</code> classes to colorize
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle"><code>background-color</code> utilities are generated with Sass
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Colorize text with color utilities. If you want to colorize links,
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">text color utilities are generated with Sass using CSS variables.
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">The <code>opacity</code> property sets the opacity level for an
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Use border utilities to <b>add</b> an element’s borders. Choose
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Use border utilities to <b>remove</b> an element’s borders. Choose
                    from all borders or one at a time.</p>
            </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Change the border color using utilities built on our theme colors.
                </p>
            </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">choose from any of the <code>.border-opacity</code> utilities:</p>
            </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Add classes to an element to easily round its corners.</p>
            </div>
            ...
            <div class="card-body pt-2">
                ...
                <div class="d-flex align-items-start flex-wrap gap-2">
                    ...
                    <img src="/images/small/img-3.jpg" class="img-fluid rounded-pill" alt="rounded-pill"
                        width="100">
                </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Use the scaling classes for larger or smaller rounded corners.
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Use <code>user-select-all</code>, <code>user-select-auto</code>,
                    or
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Bootstrap provides <code>.pe-none</code> and <code>.pe-auto</code>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Adjust the <code>overflow</code> property on the fly with four
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Arrange elements easily with the edge positioning utilities. The
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">In addition, you can also center the elements with the transform
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">By adding <code>.translate-middle-x</code> or
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">While shadows on components are disabled by default in Bootstrap
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Width utilities are generated from the utility API in
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Height utilities are generated from the utility API in
                    <code>_utilities.scss</code>. Includes support for
                    <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and
                    <code>auto</code> by default. Modify
                    those values as you need to generate different utilities here.
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Change the value of the <a
            ...
            <div class="card-body pt-2">
                <div class="d-flex align-items-start flex-wrap gap-3 text-center">
                    <div>
                        <img src="/images/small/img-1.jpg" class="object-fit-contain border rounded avatar-xl"
                            alt="...">
                        <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-contain</code></p>
                    </div>
                    <div>
                        <img src="/images/small/img-1.jpg" class="object-fit-cover border rounded avatar-xl"
                            alt="...">
                        <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-cover</code></p>
                    </div>
                    <div>
                        <img src="/images/small/img-1.jpg" class="object-fit-fill border rounded avatar-xl"
                            alt="...">
                        <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-fill</code></p>
                    </div>
                    <div>
                        <img src="/images/small/img-1.jpg" class="object-fit-scale border rounded avatar-xl"
                            alt="...">
                        <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-scale</code></p>
                    </div>
                    <div>
                        <img src="/images/small/img-1.jpg" class="object-fit-none border rounded avatar-xl"
                            alt="...">
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Use <code>z-index</code> utilities to stack elements on top of one
