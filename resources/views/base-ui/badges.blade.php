...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'Badges'])
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body pt-2">
                <h1>h1.Example heading <span class="badge bg-secondary-subtle text-secondary">New</span></h1>
