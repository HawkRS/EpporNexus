...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'Dropdowns'])
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-lg-6">
                        ...
                        <p class="card-subtitle">
                            You can optionally use <code>&lt;button&gt;</code> elements in your dropdowns instead of
                            <code>&lt;a&gt;</code>s.
                        </p>
                        <div class="pt-2">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-example mt-2" aria-labelledby="dropdownMenu1">
        ...
        <div class="card">
            ...
            <div class="card-body pt-2">
                ...
                <div class="btn-group dropup me-1">
                    <button type="button"
                        class="btn btn-purple dropdown-toggle waves-effect waves-light drop-arrow-none"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="btn-group dropend me-1">
                    <button type="button"
                        class="btn btn-pink dropdown-toggle waves-effect waves-light drop-arrow-none"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
