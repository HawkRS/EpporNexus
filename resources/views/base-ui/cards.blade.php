...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'Cards'])
<div class="row">
...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <img class="card-img-bottom img-fluid" src="/images/small/img-2.jpg" alt="Card image cap">
        </div>
    </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="row no-gutters align-items-center">
                        <div class="col-md-5">
                            <img src="/images/small/img-5.jpg" class="card-img" alt="...">
                        </div>
                        <div class="col-md-7">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-md-5">
                            <img src="/images/small/img-6.jpg" class="card-img" alt="...">
                        </div>
...
<div class="row mt-4">
    <div class="col-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <img class="card-img img-fluid" src="/images/small/img-4.jpg" alt="Card image cap">
                </div>
                <div class="card card-body text-right">
                    <blockquote class="card-bodyquote mb-0">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
