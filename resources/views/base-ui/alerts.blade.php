...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'Alerts'])
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body pt-2">
                ...
                <div class="alert alert-secondary d-flex align-items-center" role="alert">
                    <iconify-icon icon="solar:bicycling-round-bold-duotone" class="font-20 me-1"></iconify-icon>
                ...
                <div class="alert alert-danger d-flex align-items-center" role="alert">
                    <iconify-icon icon="solar:danger-triangle-bold-duotone" class="font-20 me-1"></iconify-icon>
                    <div class="lh-1"><strong>Error - </strong> A simple danger alert — check it
                        out!</div>
                </div>
                <div class="alert alert-warning d-flex align-items-center" role="alert">
                    <iconify-icon icon="solar:shield-warning-line-duotone" class="font-20 me-1"></iconify-icon>
