...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'Scrollspy'])
<div class="card">
    <div class="card-header">
        <h5 class="crad-title mb-3">Example in navbar</h5>
        <p class="card-subtitle">Scroll the area below the navbar and watch the active
...
<div class="card">
    <div class="card-header">
        <h5 class="crad-title mb-3">Example with nested nav</h5>
        <p class="card-subtitle">Scrollspy also works with nested <code>.nav</code>s.
...
<div class="card">
    <div class="card-header">
        <h5 class="crad-title mb-3">Example with list-group</h5>
        <p class="card-subtitle">Scrollspy also works with nested <code>.nav</code>s.
            If a nested <code>.nav</code> is <code>.active</code>, its parents will also be
            <code>.active</code>. Scroll the area next to the navbar and watch the active
            class change.
