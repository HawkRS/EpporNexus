                        ...
                        <div class="card-body pt-2">
                            <div>
                                <div class="d-flex flex-wrap align-items-center gap-2">
                                    ...
                                    <button type="button"
                                        class="btn btn-purple waves-effect waves-light">Purple</button>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body pt-2">
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                <button type="button"
                                    class="btn btn-primary rounded-pill waves-effect waves-light">Primary</button>
                                <button type="button"
                                    class="btn btn-secondary rounded-pill waves-effect">Secondary</button>
                                <button type="button"
                                    class="btn btn-success rounded-pill waves-effect waves-light">Success</button>
                                <button type="button"
                                    class="btn btn-info rounded-pill waves-effect waves-light">Info</button>
                                <button type="button"
                                    class="btn btn-warning rounded-pill waves-effect waves-light">Warning</button>
                                <button type="button"
                                    class="btn btn-danger rounded-pill waves-effect waves-light">Danger</button>
                                <button type="button"
                                    class="btn btn-dark rounded-pill waves-effect waves-light">Dark</button>
                                <button type="button" class="btn btn-light rounded-pill waves-effect">Light</button>
                                <button type="button"
                                    class="btn btn-purple rounded-pill waves-effect waves-light">Purple</button>
                                <button type="button"
                                    class="btn btn-pink rounded-pill waves-effect waves-light">Pink</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="card-subtitle">
                                ...
                                modifier classes with the <code>.btn-*-outline</code> ones to remove all background
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="card-subtitle">
                                In need of a button, but not the hefty background colors they bring? Replace the default
                                modifier classes with the <code>.btn-*-outline</code> <code>.rounded-pill</code> ones to
                        ...
                        <div class="card-body pt-2">
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                <button type="button"
                                    class="btn btn-outline-primary rounded-pill waves-effect waves-light">Primary</button>
                                <button type="button"
                                    class="btn btn-outline-secondary rounded-pill waves-effect">Secondary</button>
                                <button type="button"
                                    class="btn btn-outline-success rounded-pill waves-effect waves-light">Success</button>
                                <button type="button"
                                    class="btn btn-outline-info rounded-pill waves-effect waves-light">Info</button>
                                <button type="button"
                                    class="btn btn-outline-warning rounded-pill waves-effect waves-light">Warning</button>
                                <button type="button"
                                    class="btn btn-outline-danger rounded-pill waves-effect waves-light">Danger</button>
                                <button type="button"
                                    class="btn btn-outline-purple rounded-pill waves-effect waves-light">Purple</button>
                                <button type="button"
                                    class="btn btn-outline-pink rounded-pill waves-effect waves-light">Pink</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body pt-2">
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                <button type="button"
                                    class="btn btn-primary waves-effect waves-light width-xs">Xs</button>
                                <button type="button"
                                    class="btn btn-purple waves-effect waves-light width-sm">Small</button>
                                <button type="button"
                                    class="btn btn-info waves-effect waves-light width-md">Middle</button>
                                <button type="button"
                                    class="btn btn-warning waves-effect waves-light width-lg">Large</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-2">
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                ...
                                <button class="btn btn-success waves-effect waves-light">Normal button</button>
                                <button class="btn btn-purple waves-effect waves-light btn-sm">Small button</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="card-subtitle">
                                ...
                                with class <code>.btn-label</code> and any <code>icon</code> inside it. If you want to
                                put
                                icon on right side then add class <code>.btn-label-right</code> in
                                <code>&lt;span&gt;</code>
                            </p>
                        </div>
                        <div class="card-body pt-2">
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                ...
                                <button type="button" class="btn btn-success waves-effect waves-light">Right
                                    <span class="btn-label btn-label-right"><i class="mdi mdi-arrow-right"></i>
                                    </span>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="card-body pt-2">
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                ...
                                <button class="btn  btn-secondary waves-effect"> <i
                                        class="mdi mdi-heart-half-full me-1"></i> <span>Like</span> </button>
                                <button class="btn btn-dark waves-effect waves-light"> <i
                                        class="mdi mdi-email-outline me-1"></i> <span>Share</span> </button>
                                ...
                                <button class="btn btn-info waves-effect waves-light disabled"> <i
                                        class="mdi mdi-cloud-outline me-1"></i> <span>Cloud Hosting</span> </button>
                                <button class="btn btn-pink waves-effect waves-light"> <span>Book Flight</span> <i
                                        class="mdi mdi-airplane ms-1"></i> </button>
                                <button class="btn btn-purple waves-effect waves-light"> <span>Donate Money</span> <i
                                        class="mdi mdi-cash-multiple ms-1"></i> </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-2">
                            <div class="d-grid gap-2">
                                <button type="button" class="btn  btn-lg btn-primary waves-effect waves-light">Block
                                    Button</button>
                                <button type="button"
                                    class="btn  btn-md btn-pink waves-effect waves-light active">Block Button</button>
                                <button type="button" class="btn  btn-sm btn-success waves-effect waves-light">Block
                                    Button</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="btn-group-vertical mt-2">
                                        ...
                                        <button type="button" class="btn btn-secondary dropdown-toggle"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Button 3 <i class="mdi mdi-chevron-down"></i>
                                        </button>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="#">Dropdown link</a>
                                            <a class="dropdown-item" href="#">Dropdown link</a>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="card-subtitle">
                                Do more with buttons. Control button states or create groups of buttons for more
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                <button type="button" class="btn btn-icon btn-facebook waves-effect waves-light">
                                    <i class="mdi mdi-facebook"></i>
                                </button>

                                <button type="button" class="btn btn-icon btn-twitter waves-effect waves-light">
                                    <i class="mdi mdi-twitter"></i>
                                </button>

                                <button type="button" class="btn btn-icon btn-linkedin waves-effect waves-light">
                                    <i class="mdi mdi-linkedin"></i>
                                </button>

                                <button type="button" class="btn btn-icon btn-dribbble waves-effect waves-light">
                                    <i data-lucide="dribbble" height="14" width="14"></i>
                                </button>

                                <button type="button" class="btn btn-icon btn-googleplus waves-effect waves-light">
                                    <i class="mdi mdi-google-plus"></i>
                                </button>

                                <button type="button" class="btn btn-icon btn-instagram waves-effect waves-light">
                                    <i class="mdi mdi-instagram"></i>
                                </button>

                                <button type="button" class="btn btn-icon btn-pinterest waves-effect waves-light">
                                    <i class="mdi mdi-pinterest"></i>
                                </button>

                                <button type="button" class="btn btn-icon btn-dropbox waves-effect waves-light">
                                    <i class="mdi mdi-dropbox"></i>
                                </button>

                                <button type="button" class="btn btn-icon btn-skype waves-effect waves-light">
                                    <i class="mdi mdi-skype"></i>
                                </button>

                                <button type="button" class="btn btn-icon btn-youtube waves-effect waves-light">
                                    <i class="mdi mdi-youtube"></i>
                                </button>

                                <button type="button" class="btn btn-icon btn-github waves-effect waves-light">
