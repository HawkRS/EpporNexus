...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'Progress'])
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="header-title">Examples</h5>
                <p class="card-subtitle">A progress bar can be used to show a user how far along he/she is in a process.
                </p>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">We only set a <code>height</code> value on the <code>.progress</code>, so if
                    you change that value the inner <code>.progress-bar</code> will automatically resize accordingly.
                    Use
        ...
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Include multiple progress bars in a progress component if you need.</p>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">The striped gradient can also be animated. Add
        ...
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Add <code>.progress-bar-striped</code> to any <code>.progress-bar</code> to
                    apply a stripe via CSS gradient over the progress bar’s background color.</p>
            </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Add labels to your progress bars by placing text within the
