...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'Offcanvas'])
<div class="row">
    <div class="col-xl-6">
        <div class="card">
    ...
    <div class="col-xl-6">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Change the appearance of offcanvases with utilities to better match them to different contexts like dark navbars.
