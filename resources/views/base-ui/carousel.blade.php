...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'Carousel'])
<div class="row">
    <div class="col-lg-6">
        <div class="card">
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img class="d-block img-fluid w-100" src="/images/small/img-1.jpg" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid w-100" src="/images/small/img-2.jpg" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid w-100" src="/images/small/img-3.jpg" alt="Third slide">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body pt-2">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img class="d-block img-fluid w-100" src="/images/small/img-4.jpg" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid w-100" src="/images/small/img-1.jpg" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid w-100" src="/images/small/img-2.jpg" alt="Third slide">
                        </div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body pt-2">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img class="d-block img-fluid w-100" src="/images/small/img-3.jpg" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid w-100" src="/images/small/img-2.jpg" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid w-100" src="/images/small/img-1.jpg" alt="Third slide">
                        </div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body pt-2">
                <div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="/images/small/img-1.jpg" alt="..." class="d-block img-fluid w-100">
                        ...
                        <div class="carousel-item">
                            <img src="/images/small/img-3.jpg" alt="..." class="d-block img-fluid w-100">
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item">
                            <img src="/images/small/img-2.jpg" alt="..." class="d-block img-fluid w-100">
                            <div class="carousel-caption d-none d-md-block">
                ...
                <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="1000">
                            <img src="/images/small/img-6.jpg" class="img-fluid d-block w-100" alt="First slide">
                        </div>
                        <div class="carousel-item" data-bs-interval="2000">
                            <img src="/images/small/img-2.jpg" class="img-fluid d-block w-100" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/small/img-1.jpg" class="img-fluid d-block w-100" alt="Third slide">
                        </div>
                    </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-subtitle">Add <code>.carousel-dark</code> to the <code>.carousel</code> for darker
                    controls, indicators, and captions. Controls are inverted compared to their default white fill with
                ...
                <div id="carouselExampleDark" class="carousel carousel-dark slide">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="10000">
                            <img src="/images/small/img-5.jpg" class="img-fluid w-100" alt="Images">
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item" data-bs-interval="2000">
                            <img src="/images/small/img-6.jpg" class="img-fluid w-100" alt="Images">
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item">
                            <img src="/images/small/img-1.jpg" class="img-fluid w-100" alt="Images">
                            <div class="carousel-caption d-none d-md-block">
