...
class="bg-primary authentication-bg-pattern d-flex align-items-center pb-0 vh-100"
@endsection
                            ...
                            <div class="account-content">
                                <div class="mt-2 text-center">
                                    <svg version="1.1" xmlns:x="&ns_extend;" xmlns:i="&ns_ai;"
                                        ...
                                        <g i:extraneous="self">
                                            <circle id="XMLID_50_" class="st0" cx="49" cy="49"
                                                r="49" />
                                            <g id="XMLID_4_">
                                    ...
                                    <a href="{{ route ('any', 'index') }}"
                                        class="btn btn-md btn-block btn-primary waves-effect waves-light mt-4 w-100">Back
                                        to Home</a>
                                </div>
                            </div>
                        </div>
