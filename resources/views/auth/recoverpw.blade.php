...
<div class="home-btn d-none d-sm-block position-absolute top-0 end-0 m-3">
    <a href="{{ route ('any', 'index') }}"><i class="fas fa-home h2 text-white"></i></a>
</div>
                            ...
                            <div class="account-content mt-4">
                                ...
                                <form class="form-horizontal" action="#">
                                    ...
                                    <div class="form-group row text-center mt-2">
                                        <div class="col-12">
                                            <button
                                                class="btn btn-md btn-block w-100 btn-primary waves-effect waves-light"
                                ...
                                <div class="row mt-4">
                                    <div class="col-sm-12 text-center">
                                        <p class="text-muted mb-0">Back to <a
                                                href="{{ route('third', ['extra-pages', 'auth', 'login']) }}"
