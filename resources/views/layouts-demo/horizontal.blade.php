...
data-layout="topnav" data-sidenav-size="default" data-bs-theme="light" data-menu-color="light" data-topbar-color="brand" data-layout-mode="fluid"
@endsection
...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="page-container">
            ...
            @include('layouts.partials/page-title', ['subtitle' => 'Layous', 'title' => 'Horizontal'])
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover m-0 table-actions-bar">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="/images/users/avatar-2.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="/images/users/avatar-3.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="/images/users/avatar-4.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="/images/users/avatar-5.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="/images/users/avatar-8.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                            </td>
...
@includebas('layouts.partials/customizer')
