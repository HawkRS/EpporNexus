@extends('layouts.vertical', ['title' => 'Icon View Layout '])
...
@section('content')
@include('layouts.partials.page-title', ['subtitle' => 'Layout', 'title' => 'Icon View'])
<div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="wigdet-two-content media-body text-end text-truncate">
                        <p class="m-0 text-uppercase fw-medium text-truncate" title="Statistics">Total Unique Visitors
                        </p>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="wigdet-two-content media-body text-end text-truncate">
                        <p class="m-0 text-uppercase fw-medium text-truncate" title="Statistics">Number of Transactions
                        </p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mb-3 fw-semibold"><i class="mdi mdi-arrow-up-bold-hexagon-outline text-success"></i>
    ...
    <div class="col-xl-4">
        <div class="card">
            ...
            <div class="card-body">
                <div class="text-center">
                    <h5 class="fw-normal text-muted">You have to pay</h5>
                    <h3 class="mb-3 fw-semibold"><i class="mdi mdi-arrow-down-bold-hexagon-outline text-danger"></i>
                ...
                <div class="table-responsive">
                    <table class="table table-hover m-0 table-actions-bar">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src="/images/users/avatar-2.jpg" alt="contact-img" title="contact-img"
                            ...
                            <tr>
                                <td>
                                    <img src="/images/users/avatar-3.jpg" alt="contact-img" title="contact-img"
                                        class="rounded-circle avatar-sm" />
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img src="/images/users/avatar-4.jpg" alt="contact-img" title="contact-img"
                                        class="rounded-circle avatar-sm" />
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img src="/images/users/avatar-5.jpg" alt="contact-img" title="contact-img"
                                        class="rounded-circle avatar-sm" />
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img src="/images/users/avatar-8.jpg" alt="contact-img" title="contact-img"
                                        class="rounded-circle avatar-sm" />
                                </td>
