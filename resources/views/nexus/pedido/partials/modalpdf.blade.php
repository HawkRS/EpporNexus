<div id="generarpdf" class="modal fade show" tabindex="-1" aria-labelledby="generarpdfLabel" style="display: block;" aria-modal="true" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="generarpdfLabel">Modal Heading</h5>
