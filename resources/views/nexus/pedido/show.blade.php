          ...
          <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12 pt-2 d-grid gap-2"> <a href="{{route('pedidos.edit', ['id'=>$pedido->id])}}" class="btn btn-block btn-warning">Editar pedido</a> </div>
                  <div class="col-12 pt-2 d-grid gap-2"> <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#PDFModal">Generar PDF</button> </div>
                  <div class="col-12 pt-2 d-grid gap-2"> <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#PaqueteriaModal">Paqueteria</button> </div>
                  <div class="col-12 pt-2 d-grid gap-2"> <a href="#" class="btn btn-block btn-primary">Cambiar cliente</a> </div>
                </div>
              </div>
            </div>
