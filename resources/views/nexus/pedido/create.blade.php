          ...
          <div class="col-md-7">
            <div class="card m-b-20">
              <div class="card-body">
                ...
                <form id="pedido-form" method="POST" action="{{ route('pedidos.store') }}">
                  @csrf
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col-12 pt-2">
                      <label class="form-group">Canal de venta:</label>
                      <select class="form-control" name="canaldeventa" id="canaldeventa">
                        <option value="1">Contacto Directo</option>
                        <option value="2">Facebook/Whats App</option>
                        <option value="3">Mercado Libre</option>
                        <option value="4">Vendedor externo</option>
                        <option value="5">Tradicional</option>
                        <option value="6">Otro</option>
                      </select>
                    </div>
                    <div class="col-12 pt-2">
                      <label class="form-group">Comentarios:</label>
