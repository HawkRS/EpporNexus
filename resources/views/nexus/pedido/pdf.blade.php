...
<body>
  ...
  <div style="display: flex; justify-content: space-between; gap: 20px; width: 100%;">
      ...
      @if($pedido->saldo >= 0)
        <div class="bancos" style="flex: 1; width: 100%;"> <!-- Añade flex: 1 y width: 100% -->
          <table>
            ...
            <tr>
              <td>Carlos Alberto Gonzalez Melendez</td>
            </tr>
            <tr>
    ...
    <div class="bancos" style="flex: 1; width: 100%;text-align: right;">
      <table class="bancostable">
        <tr>
          <td class="bg_blue fnt_white" colspan="3"><strong>PAGOS</strong></td>
        </tr>
        @foreach($pedido->pagos as $pago)
        <tr class="prodrows">
          <td>{{ $pago->fecha }}</td>
          <td>{{ $pago->metodo }} &nbsp; {{ $pago->banco }}</td>
