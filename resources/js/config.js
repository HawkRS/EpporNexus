...
(function () {
    var savedConfig = sessionStorage.getItem("__ADMINOX_CONFIG__");
    // var savedConfig = localStorage.getItem("__ADMINOX_CONFIG__");
    ...
    // Remove 'this' here, as you're already defining 'html'
