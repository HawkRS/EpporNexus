...
document.getElementById("custom-html-alert").addEventListener("click", function () {
    Swal.fire({
        ...
        buttonsStyling: false,
        confirmButtonText: '<i class="ti ti-thumb-up-filled align-bottom me-1"></i> Great!',
        cancelButtonText: '<i class="ti ti-thumb-down-filled align-bottom"></i>',
        showCloseButton: true
    })
});
...
document.getElementById("custom-padding-width-alert").addEventListener("click", function () {
    Swal.fire({
        ...
        buttonsStyling: false,
        background: '#fff url(/images/bg-pattern-light.svg)'
    })
});
